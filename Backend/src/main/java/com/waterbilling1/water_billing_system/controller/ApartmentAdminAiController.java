...
@RestController
@RequestMapping("/api/apartment-admin/ai-assistant")
@RequiredArgsConstructor
public class ApartmentAdminAiController {
    ...
    public ResponseEntity<ApiResponse<ChatResponse>> chat(
        ...
        ChatResponse response = aiAssistantService.chat(principal.getId(), "APARTMENT_ADMIN", principal.getUsername(), request);
