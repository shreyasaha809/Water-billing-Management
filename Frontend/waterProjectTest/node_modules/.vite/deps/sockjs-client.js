...
var require_xdr = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var EventEmitter = require_emitter().EventEmitter;
	var inherits = require_inherits_browser();
	var eventUtils = require_event$1();
	var browser = require_browser();
	var urlUtils = require_url();
	var debug = function() {};
...
var require_eventsource$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var EventEmitter = require_emitter().EventEmitter;
	var EventSourceDriver = require_eventsource$2();
	var debug = function() {};
...
var require_eventsource = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var AjaxBasedTransport = require_ajax_based();
	var EventSourceReceiver = require_eventsource$1();
	var XHRCorsObject = require_xhr_cors();
	var EventSourceDriver = require_eventsource$2();
...
var require_iframe_wrap = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var IframeTransport = require_iframe();
...
var require_htmlfile = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var HtmlfileReceiver = require_htmlfile$1();
	var XHRLocalObject = require_xhr_local();
	var AjaxBasedTransport = require_ajax_based();
...
var require_jsonp_polling = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var inherits = require_inherits_browser();
	var SenderReceiver = require_sender_receiver();
	var JsonpReceiver = require_jsonp$1();
	var jsonpSender = require_jsonp();
...
var require_shims = /* @__PURE__ */ __commonJSMin((() => {
	...
	function toInteger(num) {
		var n = +num;
		if (n !== n) n = 0;
		else if (n !== 0 && n !== 1 / 0 && n !== -Infinity) n = (n > 0 || -1) * Math.floor(Math.abs(n));
		return n;
	}
	function ToUint32(x) {
		return x >>> 0;
	...
	SockJS.prototype._transportMessage = function(msg) {
		...
		switch (type) {
			...
			case "m":
				...
				break;
			case "c": if (Array.isArray(payload) && payload.length === 2) this._close(payload[0], payload[1], true);
		}
	};
